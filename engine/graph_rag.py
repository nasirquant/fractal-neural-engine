                ...
                if relationship_filter:
                    ...
                    for path in paths:
                        ...
                        for i in range(len(path) - 1):
                            ...
                            if edge_data:
                                rels = [d.get("relationship") for d in edge_data.values()]
