...
class AgentState(BaseModel):
    ...
    long_term_memory_ref: Optional[str] = Field(None, description="Redis key for full history")
    knowledge_graph_ref: Optional[str] = Field(None, description="Graph node ID in GraphRAG")
    
    # Current task context
    current_objective: Optional[str] = None
    active_skill_id: Optional[str] = None
    skill_stack: List[str] = Field(default_factory=list, description="Call stack of active skills")
...
class AgentMessage(BaseModel):
    ...
    sender_id: str
    recipient_id: Optional[str] = Field(None, description="None for broadcast")
...
class SimulationTickPacket(BaseModel):
    ...
    rollback_point: Optional[int] = None
